<?php 
	...
	$dabit = $this->db->query("SELECT SUM(amount) as totalD FROM day_book WHERE dabit_cradit = 'dabit' AND pay_date = '".date("Y-m-d")."' AND clinic_id = '".$this->session->userdata("clinic_id")."'")->row();
	$cradit = $this->db->query("SELECT SUM(amount) as totalC FROM day_book WHERE dabit_cradit = 'cradit' AND pay_date = '".date("Y-m-d")."' AND clinic_id = '".$this->session->userdata("clinic_id")."'")->row();
                            ...
                            <div class="panel info-box panel-white">
                                <div class="panel-body">
                                    <div class="info-box-stats">
                                        <p class="counter"><?php echo $num; ?></p>
                                        <span class="info-box-title">Total Todays Patients Visits</span>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="weather-top">
                                                    ...
                                                    <h2 class="weather-day pull-right">Varanasi, UP<br><small><b><?php echo date("d, M, Y");?></b></small></h2>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
